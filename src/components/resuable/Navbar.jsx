          ...
          <div className="menu-content"> 
              <ul className="navbar-links">
                ...
                <div className="social-icons">
                  <a href="https://github.com/modestat?tab=repositories" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    {/* GitHub icon */}
                  ...
                  <a href="https://www.linkedin.com/in/modesta-traksleyte-a462402b0/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    {/* LinkedIn icon */}
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="mailto:trakselytemodesta@gmail.com" aria-label="Email">
                    {/* Email icon */}
